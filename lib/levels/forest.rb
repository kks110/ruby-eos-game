...
def self.attack(data)
  ...
  message[2] = "He dodges you easliy and he hits you accross the face."
...
def self.explain(data)
  ...
  message[6] = "You can stay here for food and bed for the night if you want?'"
  options = []
...
def self.refuse(data)
  message = []
  message[0] = ''"No, I'm sorry I came in to your house."
...
def self.stay_night(data)
  ...
  message[3] = "He explains the forst is dangerous."
  message[4] = "He recomends you go back the way you came to avoid the perils of the forest."
  message[5] = "You eat well and sleep well."
  ...
  options = []
  options[0] = "Back the way you came from (Recomended by Stor)"
  options[1] = "Carry on"
  choice = Gui.gui_message_intake(message, options)
  puts choice
  if choice == "Back the way you came from (recomended by stor)"
    choice = "left"
  else
    choice = "go_past"
  end
